...
to equal
    <string>: 7/7
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_gatekeeper_operator_test.go:380
```
...
```
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:382
Expected
    <string>: Error from server (NotFound): namespaces "openshift-compliance" not found
    
to contain substring
    <string>: namespace "openshift-compliance" deleted
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:389
```
...
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:367
```
...
github.com/open-cluster-management/governance-policy-framework/test/policy-collection.glob..func2.4.6.1(0x0, 0x0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:342 +0xfd
reflect.Value.call(0x1367b60, 0x15f3118, 0x13, 0x154c0a8, 0x4, 0xc000618f60, 0x0, 0x0, 0x1367b60, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:476 +0x8c7
reflect.Value.Call(0x1367b60, 0x15f3118, 0x13, 0xc000618f60, 0x0, 0x0, 0xc00008b2c8, 0x2898067ae4c2c, 0xc000101400)
	/usr/lib/golang/src/reflect/value.go:337 +0xb9
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc0003ac7c0, 0xc00008b2c0, 0x221eb00, 0x203000, 0xc000126060)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc0003ac7c0, 0x16f82a0, 0xc000475240, 0x414600, 0x0, 0x0, 0x0, 0xc000475240)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).ShouldNot(0xc0003ac7c0, 0x16f82a0, 0xc000475240, 0x0, 0x0, 0x0, 0x16edc40)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:56 +0x85
github.com/open-cluster-management/governance-policy-framework/test/policy-collection.glob..func2.4.6()
	/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:343 +0x148
github.com/open-cluster-management/governance-policy-framework/test/policy-collection.TestE2e(0xc000317c80)
...
testing.tRunner(0xc000317c80, 0x15f2fd8)
...
Expected
    <*errors.StatusError | 0xc0005d0d20>: {
        ErrStatus: {
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000026f00>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 120.000s.
Expected
    <*errors.StatusError | 0xc000248a00>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
reflect.Value.call(0x1367b60, 0x15f33a8, 0x13, 0x154c0a8, 0x4, 0xc000618f60, 0x0, 0x0, 0x1367b60, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:476 +0x8c7
reflect.Value.Call(0x1367b60, 0x15f33a8, 0x13, 0xc000618f60, 0x0, 0x0, 0xc00008b9f8, 0x288d88bd1b864, 0xc000508400)
	/usr/lib/golang/src/reflect/value.go:337 +0xb9
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc000312940, 0xc00008b9f0, 0x221eb00, 0x203000, 0x0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:78 +0xee
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc000312940, 0x16f82a0, 0xc000463d20, 0x414601, 0x0, 0x0, 0x0, 0xc000463d20)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:112 +0x8f
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc000312940, 0x16f82a0, 0xc000463d20, 0x0, 0x0, 0x0, 0x16edc40)
...
reflect.Value.call(0x1367b60, 0x15f3300, 0x13, 0x154c0a8, 0x4, 0xc000618f30, 0x0, 0x0, 0x1367b60, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:476 +0x8c7
reflect.Value.Call(0x1367b60, 0x15f3300, 0x13, 0xc000618f30, 0x0, 0x0, 0xc0004f9278, 0x2887fd8beed78, 0x221f8e0)
	/usr/lib/golang/src/reflect/value.go:337 +0xb9
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc0003b8540, 0xc0004f9270, 0x221eb00, 0x203000, 0x0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:78 +0xee
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc0003b8540, 0x16f82a0, 0xc000516160, 0x414601, 0x0, 0x0, 0x0, 0xc000516160)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:112 +0x8f
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc0003b8540, 0x16f82a0, 0xc000516160, 0x0, 0x0, 0x0, 0x16edc40)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:51 +0x85
