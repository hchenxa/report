...
```
AssertionError: Timed out retrying after 4000ms: expected 'https://multicloud-console.apps.slot-00.dev09.red-chesterfield.com/search' to include 'multicloud/search?filters={%22textsearch%22:%22name%3Aui-git%20namespace%3Aui-git-ns%20kind%3Aapplication%20apigroup%3Aapp.k8s.io%22}'
    at validateAppTableMenu (https://multicloud-console.apps.slot-00.dev09.red-chesterfield.com/__cypress/tests?p=cypress/tests/02-validate/02-validate-ui-app-table.spec.js:649:12)
    at validateResourceTable (https://multicloud-console.apps.slot-00.dev09.red-chesterfield.com/__cypress/tests?p=cypress/tests/02-validate/02-validate-ui-app-table.spec.js:748:5)
    at Context.eval (https://multicloud-console.apps.slot-00.dev09.red-chesterfield.com/__cypress/tests?p=cypress/tests/02-validate/02-validate-ui-app-table.spec.js:117:50)
```
