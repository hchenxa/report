...
| :x: | failed | RHACM4K-413: Search: Linked page [P2][Sev2][observability-usa] clusters page should have link to search page |
...
#### :x: RHACM4K-413: Search: Linked page [P2][Sev2][observability-usa] clusters page should have link to search page

```
AssertionError: Timed out retrying after 10000ms: Expected to find content: 'Search cluster' within the element: [ <a.pf-c-page__header-brand-link>, 21 more... ] but never did.
    at Context.eval (https://multicloud-console.apps.slot-00.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/06-link/01-cluster-page-search-link.spec.js:170:66)
```
