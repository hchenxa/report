...
Expected success, but got an error:
    <*errors.errorString | 0xc0000a91b0>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc000ae4010>: {
        s: "observability-addon is not ready for managed cluster acmqe-24-import-apitoken-gke",
    }
    observability-addon is not ready for managed cluster acmqe-24-import-apitoken-gke
...
Unexpected error:
    <*errors.errorString | 0xc000844820>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0000a8f10>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0008264c0>: {
        s: "observability-addon is not ready for managed cluster dhrpatel-azure-gov-fips",
    }
    observability-addon is not ready for managed cluster dhrpatel-azure-gov-fips
/workspace/tests/pkg/tests/observability_addon_test.go:75
```
...
Expected success, but got an error:
    <*errors.errorString | 0xc0001cadb0>: {
        s: "Failed to find metric name from response",
    }
    Failed to find metric name from response
...
Unexpected error:
    <*errors.errorString | 0xc0002cd9b0>: {
...
/workspace/tests/pkg/tests/observability_reconcile_test.go:196
Unexpected error:
    <*errors.errorString | 0xc000533eb0>: {
        s: "statefulset observability-alertmanager should have 3 but got 0 ready replicas",
    }
    statefulset observability-alertmanager should have 3 but got 0 ready replicas
occurred
...
Timed out after 600.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc0003c5c60>: {
...
Unexpected error:
    <*errors.errorString | 0xc000844720>: {
