# :warning: Had some failures when running regression on cluster ocp4-edge-bm-h18-0 with test snapshot 2.4.0-SNAPSHOT-2021-10-25-23-58-51 

## Jenkins job URL: https://tests-jenkins-csb-rhacm.apps.ocp4.prod.psi.redhat.com/job/acmqe-e2e-automation/368/
...
Hub Cluster: https://multicloud-console.apps.ocp4-edge-bm-h18-0.qe.lab.redhat.com

Managed Cluster Version: 4.9.0

Managed Cluster: https://console-openshift-console.apps.ocp4-edge-bm-h18-0.qe.lab.redhat.com

Detailed test result on S3: https://s3.console.aws.amazon.com/s3/buckets/acmqe-regression/?region=ap-southeast-1&prefix=data/202110270847/
...
Unexpected error:
    <*errors.errorString | 0xc000adf450>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0008523a0>: {
...
Timed out after 300.001s.
Expected success, but got an error:
    <*errors.errorString | 0xc00071a6a0>: {
...
Unexpected error:
    <*errors.StatusError | 0xc0002d5680>: {
        ErrStatus: {
