...
| :white_check_mark: | @extended GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - cleanup Delete policy policy-clusterrolebinding-delete-1619521644 |
...
| :white_check_mark: | @extended GRC UI: [P1][Sev1][policy-grc] RoleBindingPolicy governance - clean up Delete policy role-binding-cleanup-policy-1619521644 |
...
| :white_check_mark: | @extended RHACM4K-1691 - GRC UI: [P2][Sev2][policy-grc] Certificate policy controller: with wildcard, added or removed namespaces are not detected Wait for issue7520-1619521644-delete-ns1 status to become available |
...
| :white_check_mark: | @extended RHACM4K-1720 - GRC UI: [P1][Sev1][policy-grc] PodSecurityPolicy governance Verify policy test-pod-security-policy-1619521644 details at the detailed page |
...
| :white_check_mark: | @extended RHACM4K-1722 - GRC UI: [P1][Sev1][policy-grc] RoleBindingPolicy governance Policy test-role-binding-policy-1619521644 can be deleted in the policy listing |
...
| :white_check_mark: | @extended RHACM4K-1725 - GRC UI: [P1][Sev1][policy-grc] Namespace policy governance Create new policy test-namespace-policy-1619521644 using the form |
...
| :white_check_mark: | @extended RHACM4K-2294 - GRC UI: [P1][Sev1][policy-grc] - CertificatePolicy governance Create certificate policy policy-certificatepolicy-1619521644 |
...
| :white_check_mark: | @rbac RHACM4K-2584 - GRC UI: [P1][Sev1][policy-grc] Role Based Access Control tests Check rbac-test-1619521644-e2e-rbac-test-1 policy Status page as e2e-cluster-admin-cluster |
...
| :white_check_mark: | RHACM4K-1727 - GRC UI: [P1][Sev1][policy-grc] ImageManifest policy governance Disable policy test-imagemanifest-policy-1619521644 |
...
| :white_check_mark: | RHACM4K-2343 - [P1][Sev1][policy-grc] All policies page: Verify summary table Wait for policy test-policy-1-1619521644 status to become available |
| :white_check_mark: | RHACM4K-2343 - [P1][Sev1][policy-grc] All policies page: Verify summary table Wait for policy test-policy-2-1619521644 status to become available |
| :white_check_mark: | RHACM4K-2343 - [P1][Sev1][policy-grc] All policies page: Verify summary table Wait for policy test-policy-3-1619521644 status to become available |
...
| :white_check_mark: | RHACM4K-2509 - GRC UI: [P1][Sev1][policy-grc] All policy page: Verify stability of YAML Paste raw YAML of policy policy-gatekeeper-1619521644 into YAML editor |
| :white_check_mark: | RHACM4K-2509 - GRC UI: [P1][Sev1][policy-grc] All policy page: Verify stability of YAML Paste raw YAML of policy policy-limitrange-1619521644 into YAML editor |
| :white_check_mark: | RHACM4K-2509 - GRC UI: [P1][Sev1][policy-grc] All policy page: Verify stability of YAML Set policy-gatekeeper-1619521644 to an Enforced state and then back to Inform |
| :white_check_mark: | RHACM4K-2509 - GRC UI: [P1][Sev1][policy-grc] All policy page: Verify stability of YAML Set policy-limitrange-1619521644 to an Enforced state and then back to Inform |
...
| :x: | RHACM4K-412 - Search: Saved searches "after all" hook for "[P2][Sev2][search] should be able to share the saved searches" |
...
reflect.Value.call(0x1309bc0, 0x15a9670, 0x13, 0x1502683, 0x4, 0xc0005bb0e0, 0x0, 0x0, 0x1309bc0, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:460 +0x8ab
reflect.Value.Call(0x1309bc0, 0x15a9670, 0x13, 0xc0005bb0e0, 0x0, 0x0, 0x77a974dcf887, 0xc000112288, 0x77a974dcf887)
	/usr/lib/golang/src/reflect/value.go:321 +0xb4
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc0000815c0, 0xc000112280, 0x23dca80, 0x203000, 0x0)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc0000815c0, 0x16f8720, 0xc000418b70, 0x412f01, 0x0, 0x0, 0x0, 0xc000418b70)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc0000815c0, 0x16f8720, 0xc000418b70, 0x0, 0x0, 0x0, 0x16ecfa0)
...
github.com/open-cluster-management/governance-policy-framework/test/policy-collection.TestE2e(0xc0002e4b40)
...
testing.tRunner(0xc0002e4b40, 0x15a92a0)
...
Expected
    <*errors.StatusError | 0xc0004e2320>: {
        ErrStatus: {
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000313180>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <string>: I0427 13:46:32.428974   12009 request.go:655] Throttling request took 1.089067074s, request: GET:https://api.yhliu-aws1.dev09.red-chesterfield.com:6443/apis/security.internal.openshift.io/v1?timeout=32s
...
reflect.Value.call(0x1309bc0, 0x15a95c8, 0x13, 0x1502683, 0x4, 0xc0005bb0b0, 0x0, 0x0, 0x1309bc0, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:460 +0x8ab
reflect.Value.Call(0x1309bc0, 0x15a95c8, 0x13, 0xc0005bb0b0, 0x0, 0x0, 0x775319e8cb69, 0xc000315cc8, 0x775319e8cb69)
	/usr/lib/golang/src/reflect/value.go:321 +0xb4
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc000140a00, 0xc000315cc0, 0x23dca80, 0x203000, 0xc0005bb1c8)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:78 +0xe9
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc000140a00, 0x16f8720, 0xc000463df0, 0x412f01, 0x0, 0x0, 0x0, 0xc000463df0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:112 +0x8f
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc000140a00, 0x16f8720, 0xc000463df0, 0x0, 0x0, 0x0, 0x16ecfa0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:51 +0x81
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000259c20>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <string>: I0427 13:40:21.675315   11059 request.go:655] Throttling request took 1.103469561s, request: GET:https://api.yhliu-aws1.dev09.red-chesterfield.com:6443/apis/operator.openshift.io/v1?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e26e0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e3400>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <string>: I0427 13:20:14.709055    8110 request.go:655] Throttling request took 1.103501263s, request: GET:https://api.yhliu-aws1.dev09.red-chesterfield.com:6443/apis/cluster.open-cluster-management.io/v1?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Expected
    <*errors.StatusError | 0xc0004e3680>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0000b3d60>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e20a0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <string>: I0427 12:45:26.667222    4804 request.go:655] Throttling request took 1.087894447s, request: GET:https://api.yhliu-aws1.dev09.red-chesterfield.com:6443/apis/certmanager.k8s.io/v1alpha1?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e2640>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Expected success, but got an error:
    <*errors.errorString | 0xc00006be80>: {
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e3040>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004e34a0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0004ddb80>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <*errors.StatusError | 0xc000259d60>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Although you have test retries enabled, we do not retry tests when `before all` or `after all` hooks fail
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/support/index.js:2757:27)
```
...
AssertionError: Timed out retrying after 15000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1116:30)
```
...
AssertionError: Timed out retrying after 15000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1102:30)
```
...
AssertionError: Timed out retrying after 15000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1125:30)
```
...
AssertionError: Timed out retrying after 15000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1109:30)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    at Object.whenSuggestionsAreAvailable (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1632:66)
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1149:27)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1154:27)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1190:27)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1167:27)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1159:27)
```
...
AssertionError: Timed out retrying after 2000ms: Expected to find element: `.pf-l-gallery`, but never found it.
    at Object.whenExpandRelationshipTiles (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1489:8)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1140:28)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1174:27)
```
...
AssertionError: Timed out retrying after 15000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.yhliu-aws1.dev09.red-chesterfield.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1183:27)
```
