# :warning: Had some failures when running regression on cluster ocp-bm-e20-h31-0 with test snapshot 2.4.0-SNAPSHOT-2021-10-15-04-37-58 

## Jenkins job URL: https://tests-jenkins-csb-rhacm.apps.ocp4.prod.psi.redhat.com/job/acmqe-e2e-automation/337/
...
Detailed test result on S3: https://s3.console.aws.amazon.com/s3/buckets/acmqe-regression/?region=ap-southeast-1&prefix=data/202110190807/
...
```
/workspace/tests/pkg/tests/observability_addon_test.go:30
Unexpected error:
    <*errors.errorString | 0xc00055ec80>: {
        s: "no managedcluster found",
    }
    no managedcluster found
occurred
/workspace/tests/pkg/tests/observability_addon_test.go:32
```
...
/workspace/tests/pkg/tests/observability_addon_test.go:30
Unexpected error:
    <*errors.errorString | 0xc000878820>: {
        s: "no managedcluster found",
    }
    no managedcluster found
occurred
...
/workspace/tests/pkg/tests/observability_addon_test.go:30
Unexpected error:
    <*errors.errorString | 0xc000878ff0>: {
        s: "no managedcluster found",
    }
    no managedcluster found
occurred
...
/workspace/tests/pkg/tests/observability_addon_test.go:30
Unexpected error:
    <*errors.errorString | 0xc000934870>: {
        s: "no managedcluster found",
    }
    no managedcluster found
occurred
...
testing.tRunner(0xc0004cb040, 0x2155d88)
...
Expected success, but got an error:
    <*errors.errorString | 0xc000630390>: {
...
Unexpected error:
    <*errors.StatusError | 0xc00073a0a0>: {
        ErrStatus: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0006ba7c0>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0006bbff0>: {
        s: "The observability-thanos-rule is not being restarted in 10 minutes",
    }
    The observability-thanos-rule is not being restarted in 10 minutes
