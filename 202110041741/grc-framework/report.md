...
```
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:96
Expected
    <string>: Error from server (NotFound): scansettingbindings.compliance.openshift.io "e8" not found
    
to contain substring
    <string>: scansettingbinding.compliance.openshift.io "e8"
/go/src/github.com/open-cluster-management/governance-policy-framework/test/policy-collection/policy_comp_operator_test.go:105
```
...
Timed out after 30.002s.
Expected
    <*errors.StatusError | 0xc00032d400>: {
        ErrStatus: {
...
Expected
    <*errors.StatusError | 0xc0003fc6e0>: {
        ErrStatus: {
            TypeMeta: {Kind: "Status", APIVersion: "v1"},
            ListMeta: {
                SelfLink: "",
...
Expected
    <*errors.StatusError | 0xc000291720>: {
        ErrStatus: {
            TypeMeta: {Kind: "Status", APIVersion: "v1"},
            ListMeta: {
                SelfLink: "",
...
reflect.Value.call(0x13348e0, 0x15b1be8, 0x13, 0x150b494, 0x4, 0xc0005a0f48, 0x0, 0x0, 0x203000, 0x203000, ...)
	/usr/local/go/src/reflect/value.go:476 +0x8e7
reflect.Value.Call(0x13348e0, 0x15b1be8, 0x13, 0xc0005a0f48, 0x0, 0x0, 0x3, 0x18, 0x7f1495bfe6c0)
	/usr/local/go/src/reflect/value.go:337 +0xb9
github.com/onsi/gomega/internal.NewAsyncAssertion.func1(0xc991c12955cb, 0xc00007e508, 0xc991c12955cb, 0xc0004c8c00, 0xc00004e6d8)
...
github.com/onsi/gomega/internal.(*AsyncAssertion).pollActual(0xc00007e4b0, 0xc00007e500, 0x1fbbf80, 0x0, 0xc0000423f0)
...
github.com/onsi/gomega/internal.(*AsyncAssertion).match(0xc00007e4b0, 0x16c1468, 0xc00047f620, 0x410101, 0x0, 0x0, 0x0, 0xc00047f620)
...
github.com/onsi/gomega/internal.(*AsyncAssertion).Should(0xc00007e4b0, 0x16c1468, 0xc00047f620, 0x0, 0x0, 0x0, 0xc00007e4b0)
...
github.com/open-cluster-management/governance-policy-framework/test/policy-collection.TestE2e(0xc000373080)
...
testing.tRunner(0xc000373080, 0x15b18d8)
...
reflect.Value.call(0x13348e0, 0x15b1b70, 0x13, 0x150b494, 0x4, 0xc000710f40, 0x0, 0x0, 0x203000, 0x203000, ...)
	/usr/local/go/src/reflect/value.go:476 +0x8e7
reflect.Value.Call(0x13348e0, 0x15b1b70, 0x13, 0xc000710f40, 0x0, 0x0, 0x2, 0x18, 0x7f146c693d20)
	/usr/local/go/src/reflect/value.go:337 +0xb9
github.com/onsi/gomega/internal.NewAsyncAssertion.func1(0xc939570d2b30, 0xc0005b4eb8, 0xc939570d2b30, 0x1fbcd80, 0xc000050ed8)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/async_assertion.go:48 +0xaa
github.com/onsi/gomega/internal.(*AsyncAssertion).pollActual(0xc0005b4e60, 0xc0005b4eb0, 0x1fbbf80, 0x0, 0x0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/async_assertion.go:117 +0x4f
github.com/onsi/gomega/internal.(*AsyncAssertion).match(0xc0005b4e60, 0x16c1468, 0xc0002a1c00, 0x410101, 0x0, 0x0, 0x0, 0xc0002a1c00)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/async_assertion.go:147 +0x92
github.com/onsi/gomega/internal.(*AsyncAssertion).Should(0xc0005b4e60, 0x16c1468, 0xc0002a1c00, 0x0, 0x0, 0x0, 0xc0005b4e60)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/async_assertion.go:92 +0x74
