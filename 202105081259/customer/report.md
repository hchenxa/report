...
| :white_check_mark: | @extended GRC UI: [P1][Sev1][policy-grc] IamPolicy governance - cleanup Delete policy policy-clusterrolebinding-delete-1620487552 |
...
| :white_check_mark: | @extended RHACM4K-1648 - GRC UI: [P2][Sev2][policy-grc] CertPolicy with wrong namespace selector Delete policy test-issue3677-cert-policy-1620487552 |
...
| :white_check_mark: | @extended RHACM4K-1691 - GRC UI: [P2][Sev2][policy-grc] Certificate policy controller: with wildcard, added or removed namespaces are not detected Verify that policy issue7520-1620487552-create-cert-ns2 is not present in the policy listing |
...
| :white_check_mark: | @extended RHACM4K-1719 - GRC UI: [P1][Sev1][policy-grc] IamPolicy governance Policy test-iam-policy-1620487552 can be deleted in the policy listing |
...
| :white_check_mark: | @extended RHACM4K-1725 - GRC UI: [P1][Sev1][policy-grc] Namespace policy governance Create new policy test-namespace-policy-1620487552 using the form |
...
| :white_check_mark: | @extended RHACM4K-2294 - GRC UI: [P1][Sev1][policy-grc] - CertificatePolicy governance Create certificate policy policy-certificatepolicy-1620487552 |
...
| :x: | @rbac RHACM4K-2584 - GRC UI: [P1][Sev1][policy-grc] Role Based Access Control tests Check rbac-test-1620487552-e2e-rbac-test-1 policy Status page as e2e-edit-ns |
...
| :x: | @rbac RHACM4K-2584 - GRC UI: [P1][Sev1][policy-grc] Role Based Access Control tests Logout e2e-view-ns user |
...
| :x: | RBAC users to read the Overview page RHACM4K-919[P1][Sev1][search] As an user with name search-e2e-view-ns with ns-role-binding of default view role, the user can read the Overview page. |
...
| :white_check_mark: | RHACM4K-1727 - GRC UI: [P1][Sev1][policy-grc] ImageManifest policy governance Check that enforced policy test-imagemanifest-policy-1620487552 is present in the policy listing |
...
reflect.Value.call(0x1309bc0, 0x15a9670, 0x13, 0x1502683, 0x4, 0xc00082f0e0, 0x0, 0x0, 0x1309bc0, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:460 +0x8ab
reflect.Value.Call(0x1309bc0, 0x15a9670, 0x13, 0xc00082f0e0, 0x0, 0x0, 0x3ed037f82c5be, 0xc0003138b8, 0x3ed037f82c5be)
	/usr/lib/golang/src/reflect/value.go:321 +0xb4
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc0004f2b40, 0xc0003138b0, 0x23dca80, 0x203000, 0x0)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc0004f2b40, 0x16f8720, 0xc000592490, 0x412f01, 0x0, 0x0, 0x0, 0xc000592490)
...
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc0004f2b40, 0x16f8720, 0xc000592490, 0x0, 0x0, 0x0, 0x16ecfa0)
...
Expected
    <*errors.StatusError | 0xc0004c0a00>: {
        ErrStatus: {
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc00058db80>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 63.307s.
Expected
    <string>: I0508 20:10:46.457351   11472 request.go:655] Throttling request took 1.001270262s, request: GET:https://api.rosa-acmqe4.hz70.p1.openshiftapps.com:6443/apis/upgrade.managed.openshift.io/v1alpha1?timeout=32s
...
reflect.Value.call(0x1309bc0, 0x15a95c8, 0x13, 0x1502683, 0x4, 0xc00082f0b0, 0x0, 0x0, 0x1309bc0, 0x1, ...)
	/usr/lib/golang/src/reflect/value.go:460 +0x8ab
reflect.Value.Call(0x1309bc0, 0x15a95c8, 0x13, 0xc00082f0b0, 0x0, 0x0, 0x3ecab75fa7e67, 0xc0003136d8, 0x3ecab75fa7e67)
	/usr/lib/golang/src/reflect/value.go:321 +0xb4
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).pollActual(0xc000081400, 0xc0003136d0, 0x23dca80, 0x203000, 0xc00082f1c8)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:78 +0xe9
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).match(0xc000081400, 0x16f8720, 0xc000650170, 0x412f01, 0x0, 0x0, 0x0, 0xc000650170)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:112 +0x8f
github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion.(*AsyncAssertion).Should(0xc000081400, 0x16f8720, 0xc000650170, 0x0, 0x0, 0x0, 0x16ecfa0)
	/go/src/github.com/open-cluster-management/governance-policy-framework/vendor/github.com/onsi/gomega/internal/asyncassertion/async_assertion.go:51 +0x81
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000507ae0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 63.295s.
Expected
    <string>: I0508 20:04:28.335064   10673 request.go:655] Throttling request took 1.012626754s, request: GET:https://api.rosa-acmqe4.hz70.p1.openshiftapps.com:6443/apis/managed.openshift.io/v1alpha2?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc00058cd20>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0007d06e0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 63.476s.
Expected
    <string>: I0508 19:44:16.334049    7927 request.go:655] Throttling request took 1.021944161s, request: GET:https://api.rosa-acmqe4.hz70.p1.openshiftapps.com:6443/apis/machineconfiguration.openshift.io/v1?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0007d0780>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000367b80>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 63.445s.
Expected
    <string>: I0508 19:09:11.979191    4890 request.go:655] Throttling request took 1.025705035s, request: GET:https://api.rosa-acmqe4.hz70.p1.openshiftapps.com:6443/apis/quota.openshift.io/v1?timeout=32s
    Error from server (NotFound): validatingwebhookconfigurations.admissionregistration.k8s.io "gatekeeper-validating-webhook-configuration" not found
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0003666e0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find content: 'grc-e2e-htpasswd' but never did.

Because this error occurred during a `before all` hook we are skipping all of the remaining tests.
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:17454:12)
```
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find element: `#create-policy`, but never found it.
    at action_checkPolicyListingPageUserPermissions (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:19404:28)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:17845:59)
```
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find element: `div.page-content-container`, but never found it.
    at action_doTableSearch (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:18942:6)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:17833:49)
```
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find element: `button[aria-label="namespace"]`, but never found it.
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13751:10)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=ae2d90045b58872f94a84eba31b8f079%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=19ccb8be68970aa6324b3bf3c39fa6b2%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=f1544b6f62beced3d7024c29da7e4c89%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=4293a2518889aabe654973ece5fc5e72%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=b381f95a4cc4355fbf4899db533a73b9%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=932987896c9a4831218117c2ec5c6dc4%3A%2Fmulticloud%2Fpolicies%2Fcreate' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13776:16)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected '/oauth/authorize' to equal '/multicloud/policies/all'
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:17652:27)
```
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find element: `.pf-c-page__main-nav .pf-c-nav__link`, but never found it.
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13721:10)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=d546fa91fcd6c327da5e78b96e86db7f%3A%2Fmulticloud%2Fpolicies' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13738:20)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=33730cc956723deae95c1895009b127c%3A%2Fmulticloud%2Fpolicies' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13738:20)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=ea23e800964eb212ad02c56a1388ddb5%3A%2Fmulticloud%2Fpolicies' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13738:20)
```
...
```
AssertionError: Timed out retrying after 60000ms: expected 'https://oauth-openshift.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/oauth/authorize?approval_prompt=force&client_id=multicloudingress&redirect_uri=https%3A%2F%2Fmulticloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com%2Foauth%2Fcallback&response_type=code&scope=user%3Afull&state=f0f8b036b5d069132394a7880a0310c6%3A%2Fmulticloud%2Fpolicies' to match /\/multicloud\/policies\/all[?]?/
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC.spec.js:13738:20)
```
...
```
AssertionError: Timed out retrying after 60000ms: Expected to find element: `.pf-c-app-launcher.pf-m-align-right.co-app-launcher.co-user-menu`, but never found it.
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:17537:6)
```
...
```
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_observatorium_preserve_test.go:72
Unexpected error:
    <*errors.errorString | 0xc0008beae0>: {
...
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_observatorium_preserve_test.go:79
```
...
```
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_default_config_test.go:82
Unexpected error:
    <*errors.errorString | 0xc000516480>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_default_config_test.go:89
```
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_default_config_test.go:82
Unexpected error:
    <*errors.errorString | 0xc0005e0e10>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
Timed out after 205.609s.
Expected success, but got an error:
    <*errors.errorString | 0xc000412080>: {
        s: "Failed to access managed cluster metrics via grafana console",
    }
    Failed to access managed cluster metrics via grafana console
...
```
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:210
Unexpected error:
    <*errors.errorString | 0xc000b24a20>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:217
```
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:210
Unexpected error:
    <*errors.errorString | 0xc0008decc0>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:210
Unexpected error:
    <*errors.errorString | 0xc000b24d10>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:210
Unexpected error:
    <*errors.errorString | 0xc0005e0bd0>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
```
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_endpoint_preserve_test.go:142
Unexpected error:
    <*errors.errorString | 0xc0005e1980>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_endpoint_preserve_test.go:149
```
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_endpoint_preserve_test.go:142
Unexpected error:
    <*errors.errorString | 0xc0005e0db0>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
Expected success, but got an error:
    <*errors.errorString | 0xc00011a620>: {
...
Timed out after 300.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc000433870>: {
...
Expected success, but got an error:
    <*errors.errorString | 0xc0001655d0>: {
        s: "Statefulset observability-thanos-query should have 2 but got 0 ready replicas",
    }
    Statefulset observability-thanos-query should have 2 but got 0 ready replicas
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_reconcile_test.go:158
```
...
Timed out after 600.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc000580ff0>: {
...
Timed out after 600.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc000598b10>: {
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_reconcile_test.go:192
```
...
Timed out after 600.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc0005987c0>: {
        s: "Statefulset observability-thanos-rule should have 3 but got 0 ready replicas",
    }
    Statefulset observability-thanos-rule should have 3 but got 0 ready replicas
...
Timed out after 310.964s.
Expected
    <*errors.errorString | 0xc0000b98d0>: {
        s: "Failed to access managed cluster metrics via grafana console",
    }
to match error
    <string>: Failed to find metric name from response
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_alert_test.go:158
```
...
Unexpected error:
    <*errors.errorString | 0xc00060d2a0>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_custom_dashboards_test.go:74
```
...
```
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_metricslist_test.go:59
Unexpected error:
    <*errors.errorString | 0xc000338110>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_metricslist_test.go:66
```
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_metricslist_test.go:59
Unexpected error:
    <*errors.errorString | 0xc00011a760>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_custom_dashboards_test.go:67
Unexpected error:
    <*errors.errorString | 0xc00094e690>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_endpoint_preserve_test.go:142
Unexpected error:
    <*errors.errorString | 0xc00091ee60>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_endpoint_preserve_test.go:142
Unexpected error:
    <*errors.errorString | 0xc0008deb90>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
Timed out after 600.000s.
Expected success, but got an error:
    <*errors.errorString | 0xc0004d8c60>: {
        s: "Statefulset observability-thanos-rule should have 3 but got 0 ready replicas",
    }
    Statefulset observability-thanos-rule should have 3 but got 0 ready replicas
...
/go/src/github.com/open-cluster-management/observability-e2e-test/pkg/tests/observability_addon_test.go:210
Unexpected error:
    <*errors.errorString | 0xc000412dc0>: {
        s: "Deployment observability-grafana should have 2 but got 6 ready replicas",
    }
    Deployment observability-grafana should have 2 but got 6 ready replicas
occurred
...
Although you have test retries enabled, we do not retry tests when `before all` or `after all` hooks fail
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:2757:27)
```
...
```
AssertionError: Timed out retrying after 10000ms: expected 'Cluster (1)' to equal 'Cluster (2)'
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/RBAC_tests.spec.js:384:82)
```
...
Expected
    <string>: I0508 19:03:49.083600    4754 request.go:655] Throttling request took 1.030959036s, request: GET:https://api.rosa-acmqe4.hz70.p1.openshiftapps.com:6443/apis/submarineraddon.open-cluster-management.io/v1alpha1?timeout=32s
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc0000b3720>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000366960>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <*errors.StatusError | 0xc000507cc0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Expected
    <*errors.StatusError | 0xc0007d00a0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc00072cbe0>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc00058c960>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 120.000s.
Expected
    <*errors.StatusError | 0xc0004c0500>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc000367c20>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 30.000s.
Expected
    <*errors.StatusError | 0xc00058d860>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
Timed out after 60.000s.
Expected
    <*errors.StatusError | 0xc0004c1b80>: {
        ErrStatus: {
            TypeMeta: {Kind: "", APIVersion: ""},
            ListMeta: {
                SelfLink: "",
...
```
AssertionError: Timed out retrying after 10000ms: expected 'Cluster (1)' to equal 'Cluster (2)'
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/overviewPage.spec.js:191:82)
```
...
Error: command reloaduntil exeeded timeout: 30000
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/support/index.js:2676:11)
```
...
```
AssertionError: Timed out retrying after 10000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1116:30)
```
...
AssertionError: Timed out retrying after 10000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1102:30)
```
...
AssertionError: Timed out retrying after 10000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1125:30)
```
...
AssertionError: Timed out retrying after 10000ms: Expected to find element: `.bx--checkbox-wrapper input[name="undefined"]`, but never found it.
    at Object.whenSelectTargetCluster (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1366:8)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1109:30)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    at Object.whenSuggestionsAreAvailable (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1632:66)
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1149:27)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1154:27)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1190:27)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1167:27)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1159:27)
```
...
AssertionError: Timed out retrying after 2000ms: Expected to find element: `.pf-l-gallery`, but never found it.
    at Object.whenExpandRelationshipTiles (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1489:8)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1140:28)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1174:27)
```
...
AssertionError: Timed out retrying after 10000ms: expected '<li#ReactTags-0.is-disabled>' to have a length above 1 but got 1
    ...
    at Object.whenEnterTextInSearchBar (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1645:17)
    at Object.whenFilterByKind (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1658:15)
    at Context.eval (https://multicloud-console.apps.rosa-acmqe4.hz70.p1.openshiftapps.com/__cypress/tests?p=tests/cypress/tests/adminSearch.spec.js:1183:27)
```
